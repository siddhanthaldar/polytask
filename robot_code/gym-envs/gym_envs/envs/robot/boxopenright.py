...
class RobotBoxOpenRightEnv(robot_env.RobotEnv):
	def __init__(self, height=84, width=84, step_size=10, enable_arm=True, enable_gripper=True, enable_camera=True, camera_view='side',
				 use_depth=False, dist_threshold=0.05, random_start=True, x_limit=None, y_limit=None, z_limit=None, pitch=0, roll=90, yaw=180, keep_gripper_closed=True, goto_zero_at_init=False):
		robot_env.RobotEnv.__init__(
			self,
			home_displacement=[1.7, -2.6, 0.5],
			height=height,
			width=width,
			step_size=step_size,
