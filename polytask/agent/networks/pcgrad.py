...
PyTorch code for the paper: Gradient Surgery for Multi-Task Learning
Link to paper: https://arxiv.org/abs/2001.06782
Code borrowed from: https://github.com/WeiChengTseng/Pytorch-PCGrad
